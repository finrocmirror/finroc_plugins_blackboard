...
public:
  ...
  mBlackboardTestServer(tFrameworkElement* parent, const std::string& name = "Server") :
    tModule(parent, name),
    blackboard("Test Blackboard", this, tBlackboardBufferMode::MULTI_BUFFERED, 20, false),
    blackboard_no_copy("Test Blackboard No Copy", this, tBlackboardBufferMode::SINGLE_BUFFERED, 20, false, nullptr)
  {
  }
...
public:
  ...
  mBlackboardTestClient(tFrameworkElement* parent, const std::string& name, bool read_ports) :
    ...
    blackboard_client("Blackboard Client", this, false, read_ports ? tBlackboardClient<tBlackboardDataType>::UseDefaultComponentInterface() : nullptr),
    reader(false),
